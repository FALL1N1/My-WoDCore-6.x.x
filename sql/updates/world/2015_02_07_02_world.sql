-- other onkill reputation
DELETE FROM `creature_onkill_reputation` WHERE `creature_id` IN (72275, 58411, 65170, 72280, 63447, 63674, 59378, 63044, 58928, 65132, 63610, 58927, 65134, 65131, 65133, 63611, 63641, 58455, 63605, 58456); 
