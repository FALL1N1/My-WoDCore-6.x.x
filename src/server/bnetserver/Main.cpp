...
int main(int argc, char** argv)
{
    ...
    TC_LOG_INFO("server.bnetserver", " ______                       __");
    TC_LOG_INFO("server.bnetserver", "/\\__  _\\       __          __/\\ \\__");
    TC_LOG_INFO("server.bnetserver", "\\/_/\\ \\/ _ __ /\\_\\    ___ /\\_\\ \\, _\\  __  __");
    TC_LOG_INFO("server.bnetserver", "   \\ \\ \\/\\`'__\\/\\ \\ /' _ `\\/\\ \\ \\ \\/ /\\ \\/\\ \\");
    TC_LOG_INFO("server.bnetserver", "    \\ \\ \\ \\ \\/ \\ \\ \\/\\ \\/\\ \\ \\ \\ \\ \\_\\ \\ \\_\\ \\");
    TC_LOG_INFO("server.bnetserver", "     \\ \\_\\ \\_\\  \\ \\_\\ \\_\\ \\_\\ \\_\\ \\__\\\\/`____ \\");
    TC_LOG_INFO("server.bnetserver", "      \\/_/\\/_/   \\/_/\\/_/\\/_/\\/_/\\/__/ `/___/> \\");
    TC_LOG_INFO("server.bnetserver", "                                 C O R E  /\\___/");
    TC_LOG_INFO("server.bnetserver", "  Warlords Of Draenor 19342 Core          \\/__/\n");
    TC_LOG_INFO("server.bnetserver", "  Project WoD 2015(c) by DorianGray ");
    TC_LOG_INFO("server.bnetserver", "  <http://TrinityCore.org/> \n");
    TC_LOG_INFO("server.bnetserver", "  Last TC Commit : 97e62c0ea5a53da71dfb788dfa88f429d04dd8c4");
