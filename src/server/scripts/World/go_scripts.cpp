...
go_veil_skith_cage
go_target_test
go_portal_HighmaulRaid
go_portal_BlackrockFoundryRaid
go_portal_ShadowmoonDungeon
go_portal_Auchindoun
go_portal_OvergrownOutpost
go_portal_UpperBlackrockSpire
go_portal_Bloodslagmines
go_portal_IronDocks
go_portal_Skyreach
go_portal_Grimraildepot
EndContentData */
...
class go_target_test : public GameObjectScript
{
public:
    go_target_test() : GameObjectScript("go_target_test") { }
...
class go_portal_HighmaulRaid : public GameObjectScript
{
public:
    go_portal_HighmaulRaid() : GameObjectScript("go_portal_HighmaulRaid") { }

    bool OnGossipHello(Player* player, GameObject* /*go*/) override
    {
            player->TeleportTo(1228, 3486.93f, 7603.74f, 11.86f, 2.03728f);
...
class go_portal_BlackrockFoundryRaid : public GameObjectScript
{
public:
    go_portal_BlackrockFoundryRaid() : GameObjectScript("go_portal_BlackrockFoundryRaid") { }

    bool OnGossipHello(Player* player, GameObject* /*go*/) override
    {
            player->TeleportTo(1205, 345.93f, 3429.74f, 307.86f, 2.03728f);
...
class go_portal_ShadowmoonDungeon : public GameObjectScript
{
public:
    go_portal_ShadowmoonDungeon() : GameObjectScript("go_portal_ShadowmoonDungeon") { }

    bool OnGossipHello(Player* player, GameObject* /*go*/) override
    {
            player->TeleportTo(1176, 1719.93f, 239.74f, 324.86f, 2.03728f);
...
class go_portal_Auchindoun : public GameObjectScript
{
public:
    go_portal_Auchindoun() : GameObjectScript("go_portal_Auchindoun") { }

    bool OnGossipHello(Player* player, GameObject* /*go*/) override
    {
            player->TeleportTo(1182, 1487.93f, 2953.74f, 36.86f, 2.03728f);
...
class go_portal_OvergrownOutpost : public GameObjectScript
{
public:
    go_portal_OvergrownOutpost() : GameObjectScript("go_portal_OvergrownOutpost") { }

    bool OnGossipHello(Player* player, GameObject* /*go*/) override
    {
            player->TeleportTo(1279, 439.93f, 1327.74f, 126.86f, 2.03728f);
...
class go_portal_UpperBlackrockSpire : public GameObjectScript
{
public:
    go_portal_UpperBlackrockSpire() : GameObjectScript("go_portal_UpperBlackrockSpire") { }

    bool OnGossipHello(Player* player, GameObject* /*go*/) override
    {
            player->TeleportTo(1358, 112.93f, -318.74f, 66.86f, 2.03728f);
...
class go_portal_Bloodslagmines : public GameObjectScript
{
public:
    go_portal_Bloodslagmines() : GameObjectScript("go_portal_Bloodslagmines") { }

    bool OnGossipHello(Player* player, GameObject* /*go*/) override
    {
            player->TeleportTo(1175, 2373.93f, -215.74f, 209.86f, 2.03728f);
...
class go_portal_IronDocks : public GameObjectScript
{
public:
    go_portal_IronDocks() : GameObjectScript("go_portal_IronDocks") { }

    bool OnGossipHello(Player* player, GameObject* /*go*/) override
    {
            player->TeleportTo(1195, 6749.93f, -533.74f, 5.86f, 2.03728f);
...
class go_portal_Skyreach : public GameObjectScript
{
public:
    go_portal_Skyreach() : GameObjectScript("go_portal_Skyreach") { }

    bool OnGossipHello(Player* player, GameObject* /*go*/) override
    {
            player->TeleportTo(1209, 1226.93f, 1744.74f, 178.86f, 2.03728f);
...
class go_portal_Grimraildepot : public GameObjectScript
{
public:
    go_portal_Grimraildepot() : GameObjectScript("go_portal_Grimraildepot") { }

    bool OnGossipHello(Player* player, GameObject* /*go*/) override
    {
            player->TeleportTo(1208, -2361.93f, -1800.74f, 10.86f, 2.03728f);
...
void AddSC_go_scripts()
{
    ...
    new go_target_test();
    new go_portal_HighmaulRaid();
    new go_portal_BlackrockFoundryRaid();
    new go_portal_ShadowmoonDungeon();
    new go_portal_Auchindoun();
    new go_portal_OvergrownOutpost();
    new go_portal_UpperBlackrockSpire();
    new go_portal_Bloodslagmines();
    new go_portal_IronDocks();
    new go_portal_Skyreach();
    new go_portal_Grimraildepot();
}
